...
public class FixButton2 extends JButton {
    ...
    private Color backgroundColor = new Color(255, 255, 230);
    ...
    public FixButton2(String text) {
        super(text);

        settingButton();
    }

    public FixButton2(Icon icon) {
        super(icon);

        settingButton();
    }

    public FixButton2(String text, Icon icon) {
        super(text, icon);
